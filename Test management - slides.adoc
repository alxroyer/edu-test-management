...
== 2.4.6. Jeux de données

CAUTION: Applications web (données évolutives)

TIP: Recherches sur critères
...
=== 2.5.6. Tests de charge et performances
...
WARNING: Code défensif // code mort

NOTE: Attendu contractuel
...
[#slide-timing-test-auto]
[.columns]
== 3.1. Timing activités de test
...
[#slide-impact-analyses-strategy]
[.columns]
== 3.2. Stratégie d'analyses d'impact
...
== 3.3. Planification constitution des tests
...
== 3.4. Exhaustivité // gestion de risque
