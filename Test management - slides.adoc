...
=== Faciliter les investigations - Exemple
...
=== Faciliter les investigations - Corrélation de logs
...
=== Faciliter la programmation - Gestion des interfaces
...
=== Perfs & stabilité - Conditions initiales
...
=== Perfs & stabilité - Refuser les instabilités
...
=== Perfs & stabilité - Non-régressions
