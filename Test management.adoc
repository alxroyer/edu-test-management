...
pour pouvoir écrire et débugguer les tests auto,
plutôt que les rédiger à l'aveugle.
...
* Nécessité de faciliter les investigations en cas de problèmes en post-mortem
  (cf. xref:section-auto-ease-investigations[xrefstyle=full]).
* Stabilité des tests
  (cf. xref:section-auto-stability-performance[xrefstyle=full]
  et xref:section-auto-refuse-instabilities[xrefstyle=full]).
* Gestion des problèmes connus
  (cf. xref:section-auto-known-issues[xrefstyle=full]).
* Risques de faux positifs
  (enregistrement de preuves de test).
* ...
...
cette section liste quelques élements à considérer au préalable.
...
===== 10 minutes max pour les non-régressions

TODO


[#section-auto-refuse-instabilities]
