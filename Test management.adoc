...
Mais ce message d'erreur reste à écrire par le développeur de test auto.
...
Les questions de performance et de stabilité des tests
...
le développeur de test aura tendance
...
* les exécutions de campagnes,
  ...
  (cf. xref:section-nonreg-times[xrefstyle=full]).
...
* la stratégie de persistance des configurations
  pour les campagnes de non-régressions
...
[#section-nonreg-times]
===== Temps des non-régressions
